...
<div class="wrap" id="pys">
    ...
    return $userData;
                ...
                <div class="card">
                    <div class="card-header">
                        pys_disable_ga_optimize_by_gdpr - Google Optimize <?php cardCollapseBtn(); ?>
                    </div>
                    <div class="card-body">
                        <p>Disable Google Optimize, can by used for custom gdpr</p>
                        <p>Param: <i>bool $status</i></p>
                        <label>Example:</label>
                        <pre class="copy_text">
                            add_filter('pys_disable_ga_optimize_by_gdpr',function ($status) {
