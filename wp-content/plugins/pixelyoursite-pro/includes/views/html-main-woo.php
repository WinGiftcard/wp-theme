...
<div class="card">
    <div class="card-header has_switch">
        <?php PYS()->render_switcher_input( 'woo_ReturingCustomer_enabled' ); ?>ReturingCustomer Event <?php cardCollapseBtn(); ?>
    </div>
    <div class="card-body">
        ...
        <?php if ( Facebook()->enabled() ) : ?>
            <div class="row">
                <div class="col">
                    <?php Facebook()->render_switcher_input( 'woo_ReturingCustomer_enabled' ); ?>
                    <h4 class="switcher-label">Send the event to Facebook</h4>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if ( GA()->enabled() ) : ?>
            <div class="row mb-1">
                <div class="col">
                    <?php GA()->render_switcher_input( 'woo_ReturingCustomer_enabled' ); ?>
                    <h4 class="switcher-label">Send the event to Google Analytics</h4>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if ( Pinterest()->enabled() ) : ?>
            <div class="row">
                <div class="col">
                    <?php Pinterest()->render_switcher_input( 'woo_ReturingCustomer_enabled' ); ?>
                    <h4 class="switcher-label">Send the event to Pinterest</h4>
                    <?php Pinterest()->renderAddonNotice(); ?>
                </div>
            </div>
        ...
        <?php if ( Bing()->enabled() ) : ?>
            <div class="row">
                <div class="col">
                    <?php Bing()->render_switcher_input( 'woo_ReturingCustomer_enabled' ); ?>
                    <h4 class="switcher-label">Send the event to Bing</h4>
                    <?php Bing()->renderAddonNotice(); ?>
                </div>
            </div>
		...
		<?php if ( Tiktok()->enabled() ) : ?>
            <div class="row">
                <div class="col">
					<?php Tiktok()->render_switcher_input( 'woo_ReturingCustomer_enabled' ); ?>
                    <h4 class="switcher-label">Send the event to TikTok</h4>
                </div>
            </div>
		<?php endif; ?>
