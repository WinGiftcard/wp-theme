...
function wooGetOrderIdFromRequest() {
    ...
    if(isset( $_REQUEST['key'] )  && $_REQUEST['key'] != "") {
        ...
        if (is_order_received_page() && empty($order_id) && !empty($wp->query_vars['order-received'])) {
    ...
    if(is_order_received_page() && isset( $_REQUEST['orderId'] )){
...
function wooIsRequestContainOrderId() {
    ...
    return  isset( $_REQUEST['key'] )  && $_REQUEST['key'] != ""
        ...
        || (is_order_received_page() && isset( $_REQUEST['orderId'] ))
